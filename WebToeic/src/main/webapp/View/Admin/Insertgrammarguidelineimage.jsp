									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Thêm hình ảnh cho bài hướng dẫn ngữ pháp
											</h4>
											...
											<form action="Uploadgrammarguidelineimage?grammarguidelineid=<%=request.getAttribute("grammarguidelineid") %>" method="POST" enctype="multipart/form-data">
												...
												<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															Thêm File: <input type="file" name="file" class="btn btn-white btn-info btn-bold">
														</span>
													</label>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-70 pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">Thêm hình cho bài hướng dẫn</span>
														</button>
													</div>
