	...
	<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
					<div class="main-content-inner">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">Quản lý phần phướng dẫn ngữ pháp</a>
							</li>
											...
											<table id="simple-table" class="table  table-bordered table-hover">
												...
												<c:forEach items="${listgrammarguidelinemanage}" var="list">
													<tr>
														...
														<td class="center">
															<a class="green" href="GrammarguidelineimageForward?id=${list.grammarguidelineid}">
									...
									<div class="row">
										<div class="col-xs-12">
											<button type="button" class="btn btn-white btn-info btn-bold" data-toggle="modal" data-target="#myModal">
												Thêm đề bài hướng dẫn ngữ pháp
											</button>
										</div>
		...
		<div id="myModal" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    ...
		    <!-- Modal content-->
		    <form action="Insertgrammarguidelinemanage" method="POST">
